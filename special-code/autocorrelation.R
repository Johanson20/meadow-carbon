...
data <- data[-ids, ]
# convert dataframe to spdf for spatial manipulation
...
# create variogram of AGB values and plot variagram model
...
# make same variogram of 2015 data (including 3D spatial plot)
